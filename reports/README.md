...
3. Michał Reczulski (s222612) was inlolved in raw data extraction, feature extraction and pixel classification with use of preprocessing. Also involved in creating docker file, setup DVC and training model.
